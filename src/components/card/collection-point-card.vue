    ...
    <div class="px-3 py-4">
      ...
      <div class="flex flex-row gap-3 mt-4">
        <button
          ...
          class="w-full cursor-pointer bg-white gap-1.5 flex items-center justify-center border border-slate-600 text-slate-600 text-sm font-medium py-2 px-2 rounded-lg transition-colors btn-scale"
        >
        ...
        <button
          ...
          class="w-full cursor-pointer bg-white gap-1.5 flex items-center justify-center text-gray-500 text-nowrap border text-sm font-medium py-2 px-2 rounded-lg transition-colors btn-scale"
        >
